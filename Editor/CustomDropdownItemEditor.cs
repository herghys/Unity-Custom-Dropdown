...
namespace Herghys.Utility.CustomDropdown.Editors
{
    [CustomEditor(typeof(CustomDropdownItem), editorForChildClasses: true)]
    [CanEditMultipleObjects]
    public class CustomDropdownItemEditor : Editor
    {
        ...
        {
            EditorGUILayout.LabelField("CustomDropdown Item Settings", EditorStyles.boldLabel);
